...
public class CharacterController2D : MonoBehaviour, IDataPersistence
{
  ...
  private void UpdateIsGrounded()
  {
    ...
    float colliderRadius =
      coll.size.x * 0.4f * Mathf.Abs(transform.localScale.x);
  ...
  private void UpdateFacingDirection()
  {
    ...
    // we do this instead of using the 'flipX' spriteRenderer option
    // because our player is made up of multiple sprites
    if (facingRight)
    {
